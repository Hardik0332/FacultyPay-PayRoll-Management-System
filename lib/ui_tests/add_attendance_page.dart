...
class AddAttendancePageUI extends StatefulWidget {
  const AddAttendancePageUI({super.key});

  @override
  State<AddAttendancePageUI> createState() => _AddAttendancePageUIState();
}

class _AddAttendancePageUIState extends State<AddAttendancePageUI> {
  ...
  Widget _buildHeader() {
    return Row(
      ...
      children: [
        const Text("Log Hours", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: -0.5)),
        Row(
          children: [
  ...
  Widget _buildDropdown({required String label, String? value, required List<String> items, String? hint, void Function(String?)? onChanged}) {
  ...
  Widget _buildSubmitButton() {
    return GestureDetector(
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: const Text("Checking form... (Firebase logic later)"), backgroundColor: primaryRed));
      },
      child: Container(
        width: double.infinity,
        ...
        child: const Center(
          child: Text("Submit Attendance", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 1)),
        ),
      ),
    );
  }
  ...
  Widget _buildRecentSubmissionsList() {
    // Dummy data matching the style of your legacy code
    return Column(
      children: [
        _buildSubmissionItem("Oct 15, 2023", "Java Programming", 2, "Pending", pendingOrange),
        _buildSubmissionItem("Oct 14, 2023", "Data Structures", 1, "Verified", verifiedBlue),
        _buildSubmissionItem("Oct 12, 2023", "Operating Systems", 3, "Paid", successGreen),
      ],
    );
  }
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(Icons.edit_document, "LOG", 1), // Updated icon and label for this context
