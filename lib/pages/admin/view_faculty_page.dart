...
class _ViewFacultyPageState extends State<ViewFacultyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ 1. Grab the current theme settings so we can use dynamic colors
    final theme = Theme.of(context);

    return Scaffold(
      // ✅ 2. Notice there is no "backgroundColor" here anymore!
      // It automatically inherits the AMOLED black from main.dart
      appBar: isDesktop
          ? null
          : AppBar(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              color: theme.cardColor, // ✅ 3. Dynamic Card Color (White or Dark Grey)
                          ...
                          child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                  value: _sortOrder,
                                  dropdownColor: theme.cardColor, // ✅ 4. Makes the dropdown menu match the theme
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Colors.grey.withOpacity(0.1), // ✅ Safe transparency works on any background
                                  ...
                                  onPressed: () async {
                                    final confirm = await showDialog<bool>(
                                      ...
                                      builder: (ctx) => AlertDialog(
                                        backgroundColor: theme.cardColor, // ✅ Match popup to theme
