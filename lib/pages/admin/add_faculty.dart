                                ...
                                children: [
                                  ...
                                  DropdownButtonFormField<String>(
                                    ...
                                    items: const [
                                      ...
                                      DropdownMenuItem(value: "sci", child: Text("Biology")),
                                      DropdownMenuItem(value: "sci", child: Text("Chemistry")),
                                      DropdownMenuItem(value: "sci", child: Text("Physics")),
                                      DropdownMenuItem(value: "sci", child: Text("Mathematics")),
                                      DropdownMenuItem(value: "arts", child: Text("Economics")),
                                      DropdownMenuItem(value: "arts", child: Text("History")),
                                      DropdownMenuItem(value: "arts", child: Text("Geography")),
                                      DropdownMenuItem(value: "arts", child: Text("Political Science")),
                                      DropdownMenuItem(value: "arts", child: Text("Psychology")),
                                    ],
